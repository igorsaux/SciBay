...
/decl/hierarchy/supply_pack/reagents/dichloromethane
	...
	containername = "\improper dichloromethane crate"
...
/decl/hierarchy/supply_pack/reagents/calcium_carbonate
	...
	containername = "\improper calcium carbonate crate"

/decl/hierarchy/supply_pack/reagents/ethanol
	name = "ethanol 95% (1 L)"
	contains = list(
		/obj/item/reagent_containers/vessel/bottle/chemical/big/ethanol
	)
	containername = "\improper ethanol crate"

/decl/hierarchy/supply_pack/reagents/acetic_acid
	name = "acetic acid 70% (1 L)"
	contains = list(
		/obj/item/reagent_containers/vessel/bottle/chemical/big/acetic_acid
	)
	containername = "\improper acetic acid crate"
...
/decl/hierarchy/supply_pack/reagents/graphite
	...
	containername = "\improper graphite crate"
...
/decl/hierarchy/supply_pack/reagents/water
	...
	containername = "\improper water crate"
...
/decl/hierarchy/supply_pack/reagents/sodium_chloride
	...
	containername = "\improper sodium chloride crate"
